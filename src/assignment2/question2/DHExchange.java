...
public class DHExchange {
    ...
    public static void main(String args[]) {
        ...
        DHExchange dhExchange = new DHExchange();
        ...
        List XandT = dhExchange.aliceGenerateSession();
        BigInteger X = (BigInteger) XandT.get(0);
        BigInteger T = (BigInteger) XandT.get(1);
    ...
    private List aliceGenerateSession() {
        X = g.modPow(x, q);
